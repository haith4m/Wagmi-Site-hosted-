      ...
      <head>
        <script
          dangerouslySetInnerHTML={{
            __html:
              '(function(){try{var t=localStorage.getItem("wagmi-theme");if(t!=="light"&&t!=="dark"){t="light";}document.documentElement.classList.toggle("dark",t==="dark");document.documentElement.style.colorScheme=t;}catch(e){}})();',
          }}
        />
      </head>
